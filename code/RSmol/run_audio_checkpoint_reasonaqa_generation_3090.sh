...
CHECKPOINT="${RSMOL_AUDIO_GENERATION_CHECKPOINT:-/hpc_stor03/sjtu_home/jinwei.zhang/outputs/RSmol/audio_5_10x2_5_mesh_mellow/partition_formal_answer_eos_v2_10epochs_20260918/checkpoint-037810}"
...
OUTPUT_DIR="${RSMOL_AUDIO_GENERATION_OUTPUT_DIR:-/hpc_stor03/sjtu_home/jinwei.zhang/outputs/RSmol/audio_5_10x2_5_mesh_mellow/reasonaqa_samples_checkpoint037810_${RUN_TAG}}"
...
vc submit \
  ...
  -d "$SCRIPT_DIR" \
  JOB=1:1 "$SCRIPT_DIR/log/audio_reasonaqa_generation_3090.${RUN_TAG}.JOB.log" \
