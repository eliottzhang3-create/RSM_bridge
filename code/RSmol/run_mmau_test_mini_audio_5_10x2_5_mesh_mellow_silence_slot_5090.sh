...
OUTPUT_DIR="${RSMOL_MMAU_SILENCE_SLOT_OUTPUT_DIR:-/hpc_stor03/sjtu_home/jinwei.zhang/outputs/RSmol/audio_5_10x2_5_mesh_mellow_silence_slot/mmau_test_mini_checkpoint_037810_fixed260_runtime_silence_v1}"
