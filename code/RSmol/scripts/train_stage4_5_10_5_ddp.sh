...
export RSMOL_STAGE4_MICRO_BATCH_SIZE="${RSMOL_5_10_5_MICRO_BATCH_SIZE:-${RSMOL_STAGE4_MICRO_BATCH_SIZE:-8}}"
export RSMOL_STAGE4_GRADIENT_ACCUMULATION_STEPS="${RSMOL_5_10_5_GRADIENT_ACCUMULATION_STEPS:-${RSMOL_STAGE4_GRADIENT_ACCUMULATION_STEPS:-16}}"
export RSMOL_STAGE4_LEARNING_RATE="${RSMOL_5_10_5_LEARNING_RATE:-${RSMOL_STAGE4_LEARNING_RATE:-2e-4}}"
export RSMOL_STAGE4_MAX_LR="${RSMOL_5_10_5_MAX_LR:-${RSMOL_STAGE4_MAX_LR:-2e-4}}"
export RSMOL_STAGE4_MIN_LR="${RSMOL_5_10_5_MIN_LR:-${RSMOL_STAGE4_MIN_LR:-2e-5}}"
