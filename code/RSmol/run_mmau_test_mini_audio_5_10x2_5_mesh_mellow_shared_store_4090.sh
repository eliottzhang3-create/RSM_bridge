...
CHECKPOINT="${RSMOL_MMAU_SHARED_STORE_CHECKPOINT:-/hpc_stor03/sjtu_home/jinwei.zhang/outputs/RSmol/audio_5_10x2_5_mesh_mellow_shared_store_configurable_epochs/formal_30epochs_20260923_v1/checkpoint-113430}"
...
OUTPUT_DIR="${RSMOL_MMAU_SHARED_STORE_OUTPUT_DIR:-/hpc_stor03/sjtu_home/jinwei.zhang/outputs/RSmol/audio_5_10x2_5_mesh_mellow_shared_store_configurable_epochs/formal_30epochs_20260923_v1/mmau_test_mini_checkpoint_113430_mellow_author_reply_protocol_v1}"
JOB_LOG="$SCRIPT_DIR/log/mmau_shared_store_113430_4090.${RUN_TAG}.JOB.log"
...
vc submit \
  ...
  -c 8 -m 32G -g 1 -n 1 \
  -j "mmau-shared-113430-${RUN_TAG}" \
  -d "$SCRIPT_DIR" \
  JOB=1:1 "$JOB_LOG" \
  --cmd "bash scripts/evaluate_mmau_test_mini_audio_5_10x2_5_mesh_mellow_shared_store.sh $CMD_ARGS"

echo "Shared-store checkpoint-113430 MMAU full output directory: ${OUTPUT_DIR}"
