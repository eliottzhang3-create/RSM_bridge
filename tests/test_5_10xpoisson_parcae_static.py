...
class PoissonParcaeStaticContractTest(unittest.TestCase):
    ...
    def test_resume_identity_and_formal_reporting_contract(self):
        ...
        self.assertIn("progress_log_due", self.stage4_text)
        self.assertIn("global_tokens_per_second", self.stage4_text)
        self.assertIn("memory_max_peak_allocated_gib", self.stage4_text)
