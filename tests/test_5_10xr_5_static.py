...
class DynamicVariantStaticContractTest(unittest.TestCase):
    ...
    def test_stage1_and_stage4_audit_contracts(self):
        for marker in (
            ...
            "incremental_semantic_ok", "incremental_semantic_is_diagnostic_only",
            "continuing to the decisive FP32 cache audit", "incremental_fp32_cache_audit",
            "values_bitwise_equal", "cross_instance_logits_is_diagnostic_only",
            "state_dict equality is the decisive serialization audit",
            "reloaded model cache/no-cache prefill logits mismatch",
